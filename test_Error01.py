#Un caso negativo donde se verifica el punto "a" del método verify_array_op
...
a = "A"
b = np.random.randint (1, 11) #Números random para el arreglo de entrada
...
def test ():
    ...
    verify_array_op (rand)import pytest #Librerías
import numpy as np
